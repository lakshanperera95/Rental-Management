...
namespace Inventory
{
    public static class clsExcel
    {
        ...
        public class ExcelColumnsForStOveright
        {
        ...
        public class ExcelColumnsOpenSt
        {
        ...
        public static List<T> ToList<T>(this ExcelWorksheet worksheet, Dictionary<string, string> map = null) where T : new()
        {
           ...
           var start = worksheet.Dimension.Start;
            ...
            ///var start = worksheet.Cells["A7:I59"].Start;
            //var end = worksheet.Cells["A7:I59"].End;

         //   var start = worksheet.SelectedRange.Start;
          //  var end = worksheet.SelectedRange.End;
