    ...
    public partial class frmTransactionInquary : Form
    {
            ...
            try
            {
                ...
                switch (intRepOption)
                {
                    ...
                    case 259:
                        ...
                        dtDateTo.Enabled = false;
                        radioButtonDocumentNo.Checked = true;
                        lblType.Text = "Pay Type";
                        cmbtype.Visible = lblType.Visible = true;
                        cmbtype.Items.Clear();
                        cmbtype.Items.Add("ALL");
                        cmbtype.Items.Add("CASH");
                    ...
                    case 210://Receipt Summary
                        ...
                        cmbUnit.DataSource = ObjComman.Ads.Tables[0];
        ...
        private void btnDocumentFrom_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MultiCus == true)
                {
                    Loca = " and Loca='" + LoginManager.LocaCode + "' ";
                }
                ...
                switch (intRepOption)
                {
                    ...
                    case 251: //Stock Adjustment
                           strQuery = "SELECT DB.DocNo,C.Cust_Name[Acc_Name],DB.PostDate[Date] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Customer C ON C.Cust_Code=DB.CutId WHERE DB.DocNo LIKE  '%"+txtCodeFrom.Text.Trim()+"%'  AND DB.Loca='"+LoginManager.LocaCode+"' ORDER BY RIGHT(DocNo,6) DESC";
                       
                        break;

                    case 252: //Stock Adjustment
                        strQuery = "SELECT DB.DocNo ,C.Supp_Name[Acc_Name],DB.PostDate[Date] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Supplier C ON C.Supp_Code=DB.CutId  WHERE DB.DocNo LIKE  '%" + txtCodeFrom.Text.Trim() + "%'  AND DB.Loca='" + LoginManager.LocaCode + "' ORDER BY RIGHT(DocNo,6) DESC";
                    ...
                    case 207:   //Customer Return
                        if (txtCodeFrom.Text.Trim() != string.Empty)
                        {
                            strQuery = "SELECT Doc_No [Document No], Post_Date [Doc Date] FROM Transaction_Header WHERE Iid = 'INV' AND Net_Amount<0 AND Loca = '" + LoginManager.LocaCode + "' AND Doc_No LIKE '%'+'" + txtCodeFrom.Text.Trim() + "'+'%' ORDER BY RIGHT(Doc_No,6) DESC";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No [Document No], Post_Date [Doc Date] FROM Transaction_Header WHERE Iid = 'INV' AND Net_Amount<0 AND Loca = '" + LoginManager.LocaCode + "' ORDER BY RIGHT(Doc_No,6) DESC";
                        }
                        break;
                    ...
                    case 211:// Customer Return Summary
                        if (txtCodeFrom.Text.Trim() != string.Empty)
                        {
                            strQuery = "SELECT Doc_No [Document No], Post_Date [Doc Date] FROM Transaction_Header WHERE Iid = 'INV' AND Net_Amount<0  AND Loca = '" + LoginManager.LocaCode + "' AND Doc_No LIKE '%'+'" + txtCodeFrom.Text.Trim() + "'+'%' ORDER BY RIGHT(Doc_No,6)";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No [Document No], Post_Date [Doc Date] FROM Transaction_Header WHERE Iid = 'INV' AND Net_Amount<0 AND Loca = '" + LoginManager.LocaCode + "' ORDER BY RIGHT(Doc_No,6)";
                        }
                        break;
                    ...
                    case 227:   //Quotation
                        ...
                        break;
                    case 231:   //Advance Report
                        strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='CADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%" + txtCodeFrom.Text.Trim() + "%' ORDER BY Org_Doc_no DESC";
                        break;
                    case 257:
                       
                            strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='CADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%" + txtCodeFrom.Text.Trim() + "%' ORDER BY Org_Doc_no ASC";
                       
                        break;
                    case 256:   //Advance Report
                        strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='SADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%" + txtCodeFrom.Text.Trim() + "%' ORDER BY Org_Doc_no DESC";

                        break;
                    case 258:
                        
                            strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='SADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%" + txtCodeFrom.Text.Trim() + "%' ORDER BY Org_Doc_no ASC";
                    ...
                    case 233:   //Combination
                        if (txtCodeFrom.Text.Trim() != string.Empty)
                        {
                            strQuery = "SELECT Doc_No, Post_Date FROM Transaction_Header WHERE Iid='BIS' AND Loca='" + LoginManager.LocaCode + "' AND Doc_No='" + txtCodeFrom.Text + "' Order by Doc_No desc";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No, Post_Date FROM Transaction_Header WHERE Iid='BIS' AND Loca='" + LoginManager.LocaCode + "' Order by Doc_No desc";
                        }
                        break;
                    case 255:
                        ...
                        if (txtCodeFrom.Text.Trim() != string.Empty)
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' AND Doc_No='" + txtCodeFrom.Text + "' Order by Doc_No asc";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' Order by Doc_No asc";
                        }
                        break;
                    ...
                    case 254:   //Bundle
                        if (txtCodeFrom.Text.Trim() != string.Empty)
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' AND Doc_No='" + txtCodeFrom.Text + "' Order by Doc_No desc";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' Order by Doc_No desc";
                        }
                        break;
                    ...
                    case 262:
                        if(txtCodeFrom.Text.Trim() != string.Empty)
                        {
                            strQuery = "select DocNo [Document],convert(varchar,Create_Date,103)[Date],Status[Status] from Job_Header  where DocNo='" + txtCodeFrom.Text.Trim() + "' AND Loca ='"+LoginManager.LocaCode+ "' order by DocNo desc";
                        }
                        else
                        {
                            strQuery = "select DocNo [Document],convert(varchar,Create_Date,103)[Date],Status[Status] from Job_Header WHERE Loca ='" + LoginManager.LocaCode + "' order by DocNo desc ";
                        }
                        break;
                    default:
                        break;
        ...
        public void btnApply_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                switch (intRepOption)
                {
                    ...
                    case 261: //Invoice Summary
                        if (radioButtonDocumentNo.Checked == true)
                        {
                            DateAll = false;
                        }

                        objRepView.SqlStatement = "EXEC dbo.Sp_GetReport  @Report = '210',@DateFrom = '" + dtDateFrom.Text + "',@DateTo = '" + dtDateTo.Text + "',@CodeFrom = '" + txtCodeFrom.Text + "',@CodeTo = '" + txtCodeTo.Text + "',@Loca = '" + LoginManager.LocaCode + "',@DateAll = '" + DateAll + "',@PayType='" + cmbtype.Text + "'";
                        ...
                        {
                            rptInvoiceProfitSummary rptInvProfDtSummary = new rptInvoiceProfitSummary();
                            dsDataForReport.Tables[1].TableName = "dsInvoiceColSummery";
                            rptInvProfDtSummary.SetDataSource(dsDataForReport);
                            objRepViewer.crystalReportViewer1.ReportSource = rptInvProfDtSummary;
                        }

                        break;

                    case 260: //Invoice Summary 
                        if (radioButtonDocumentNo.Checked == true)
                        {
                            DateAll = false;
                        }
                        ...
                        dsDataForReport = objRepView.TempResultSet;
                        {
                            rptInvoiceDetailSummary rptInvDtSummary = new rptInvoiceDetailSummary();
                            dsDataForReport.Tables[1].TableName = "dsInvoiceColSummery";
                            rptInvDtSummary.SetDataSource(dsDataForReport);
                            objRepViewer.crystalReportViewer1.ReportSource = rptInvDtSummary;
                        }

                        break;

                    case 259: //Invoice Summary
                        DateAll = true;
                        if (radioButtonDocumentNo.Checked == true)
                        {
                            DateAll = false;
                        }
                        objRepView.SqlStatement = "EXEC dbo.Sp_GetReport  @Report = '259',@DateFrom = '" + dtDateFrom.Text + "',@DateTo = '" + dtDateTo.Text + "',@CodeFrom = '" + txtCodeFrom.Text + "',@CodeTo = '" + txtCodeTo.Text + "',@Loca = '" + LoginManager.LocaCode + "',@DateAll = '" + DateAll + "',@PayType='" + cmbtype.Text + "'";
                        objRepView.DataSetName = "TransactionSummary";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        rptInvoiceSummaryProdWise rptInvSummaryProd = new rptInvoiceSummaryProdWise();
                        rptInvSummaryProd.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = rptInvSummaryProd;
                        break;

                    case 258:

                        rptAdvanceReportSummary objadvanceSuppSummary = new rptAdvanceReportSummary();

                        if (radioButtonDate.Checked)
                        {
                            objRepView.SqlStatement = " select  tbPaidPaymentSummary.Acc_Code [Sup_Cus_Id], Supplier.Supp_Name [Sup_Cus_Name],tbPaidPaymentSummary.Org_Doc_no [Doc_No],tbPaidPaymentSummary.Iid ,tbPaidPaymentSummary.Payment_Mode,tbPaidPaymentSummary.Bank_Name,tbPaidPaymentSummary.Post_Date,tbPaidPaymentSummary.Cheque_No,tbPaidPaymentSummary.Cheque_Date,tbPaidPaymentSummary.Amount,TH.Remarks,'Date From : " + dtDateFrom.Text + "  To : " + dtDateTo.Text.Trim() + "'[CodeRange] 	 FROM tbPaidPaymentSummary INNER JOIN Supplier ON tbPaidPaymentSummary.Acc_Code=Supplier.Supp_Code  	  JOIN dbo.Transaction_Header TH ON TH.Loca = tbPaidPaymentSummary.Loca AND TH.Doc_No=Org_Doc_no	    WHERE  convert(datetime,tbPaidPaymentSummary.Post_Date,103) between  convert(datetime,'" + dtDateFrom.Text + "',103)  and convert(datetime,'" + dtDateTo.Text.Trim() + "',103)  AND tbPaidPaymentSummary.Loca='" + LoginManager.LocaCode + "' Order By convert(datetime,tbPaidPaymentSummary.Post_Date,103) asc;SELECT Id_No,Address1[CompanyName],Address2[CompanyAddress],Address3[CompanyTelephone],Tel + '-' + EMail[CompanyEmail]FROM dbo.Location WHERE Loca='" + LoginManager.LocaCode + "'";
                        }
                        else
                        {
                            objRepView.SqlStatement = "select  tbPaidPaymentSummary.Acc_Code [Sup_Cus_Id], Supplier.Supp_Name [Sup_Cus_Name],tbPaidPaymentSummary.Org_Doc_no [Doc_No],tbPaidPaymentSummary.Iid ,tbPaidPaymentSummary.Payment_Mode,tbPaidPaymentSummary.Bank_Name,tbPaidPaymentSummary.Post_Date,tbPaidPaymentSummary.Cheque_No,tbPaidPaymentSummary.Cheque_Date,tbPaidPaymentSummary.Amount,TH.Remarks,'Document From : " + txtCodeFrom.Text + "  To : " + txtCodeTo.Text.Trim() + "'[CodeRange] 	 FROM tbPaidPaymentSummary INNER JOIN Supplier ON tbPaidPaymentSummary.Acc_Code=Supplier.Supp_Code  	  JOIN dbo.Transaction_Header TH ON TH.Loca = tbPaidPaymentSummary.Loca AND TH.Doc_No=Org_Doc_no    WHERE tbPaidPaymentSummary.Org_Doc_no between '" + txtCodeFrom.Text.Trim() + "' and '" + txtCodeTo.Text.Trim() + "' AND tbPaidPaymentSummary.Loca='" + LoginManager.LocaCode + "'  Order By convert(datetime,tbPaidPaymentSummary.Post_Date,103) asc;SELECT Id_No,Address1[CompanyName],Address2[CompanyAddress],Address3[CompanyTelephone],Tel + '-' + EMail[CompanyEmail]FROM dbo.Location WHERE Loca='" + LoginManager.LocaCode + "'";

                        }
                        objadvanceSuppSummary.SummaryInfo.ReportTitle = "Supplier Advance Summary";
                        ...
                        objadvanceSuppSummary.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = objadvanceSuppSummary;
                    ...
                    case 257:
                        ...
                        rptAdvanceReportSummary objadvanceCusSummry = new rptAdvanceReportSummary();

                        if (radioButtonDate.Checked)
                        {
                            objRepView.SqlStatement = " select  tbPaidPaymentSummary.Acc_Code [Sup_Cus_Id], Customer.Cust_Name [Sup_Cus_Name],tbPaidPaymentSummary.Org_Doc_no [Doc_No],tbPaidPaymentSummary.Iid ,tbPaidPaymentSummary.Payment_Mode,tbPaidPaymentSummary.Bank_Name,tbPaidPaymentSummary.Post_Date,tbPaidPaymentSummary.Cheque_No,tbPaidPaymentSummary.Cheque_Date,tbPaidPaymentSummary.Amount ,TH.Remarks,'Date From : " + dtDateFrom.Text + "  To : " + dtDateTo.Text.Trim() + "'[CodeRange] FROM tbPaidPaymentSummary INNER JOIN Customer ON tbPaidPaymentSummary.Acc_Code=Customer.Cust_Code  	    JOIN dbo.Transaction_Header TH ON TH.Loca = tbPaidPaymentSummary.Loca AND TH.Doc_No=Org_Doc_no	    WHERE  convert(datetime,tbPaidPaymentSummary.Post_Date,103) between  convert(datetime,'" + dtDateFrom.Text + "',103)  and convert(datetime,'" + dtDateTo.Text.Trim() + "',103)  AND tbPaidPaymentSummary.Loca='" + LoginManager.LocaCode + "' Order By convert(datetime,tbPaidPaymentSummary.Post_Date,103) asc;SELECT Id_No,Address1[CompanyName],Address2[CompanyAddress],Address3[CompanyTelephone],Tel + '-' + EMail[CompanyEmail]FROM dbo.Location WHERE Loca='" + LoginManager.LocaCode + "'";
                        }
                        else
                        {
                            objRepView.SqlStatement = " select  tbPaidPaymentSummary.Acc_Code [Sup_Cus_Id], Customer.Cust_Name [Sup_Cus_Name],tbPaidPaymentSummary.Org_Doc_no [Doc_No],tbPaidPaymentSummary.Iid ,tbPaidPaymentSummary.Payment_Mode,tbPaidPaymentSummary.Bank_Name,tbPaidPaymentSummary.Post_Date,tbPaidPaymentSummary.Cheque_No,tbPaidPaymentSummary.Cheque_Date,tbPaidPaymentSummary.Amount ,TH.Remarks,'Document From : " + txtCodeFrom.Text + "  To : " + txtCodeTo.Text.Trim() + "'[CodeRange] FROM tbPaidPaymentSummary INNER JOIN Customer ON tbPaidPaymentSummary.Acc_Code=Customer.Cust_Code  	    JOIN dbo.Transaction_Header TH ON TH.Loca = tbPaidPaymentSummary.Loca AND TH.Doc_No=Org_Doc_no	    WHERE tbPaidPaymentSummary.Org_Doc_no between '" + txtCodeFrom.Text.Trim() + "' and '" + txtCodeTo.Text.Trim() + "' AND tbPaidPaymentSummary.Loca='" + LoginManager.LocaCode + "'  Order By convert(datetime,tbPaidPaymentSummary.Post_Date,103) asc;SELECT Id_No,Address1[CompanyName],Address2[CompanyAddress],Address3[CompanyTelephone],Tel + '-' + EMail[CompanyEmail]FROM dbo.Location WHERE Loca='" + LoginManager.LocaCode + "'";

                        }
                        objadvanceCusSummry.SummaryInfo.ReportTitle = "Customer Advance Summary";
                        ...
                        objadvanceCusSummry.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = objadvanceCusSummry;


                        break;

                    case 255:
                        if (radioButtonDocumentNo.Checked)
                        {
                            objRepView.SqlStatement = "SELECT BDL.Doc_No, BDL.Post_Date, BDL.Main_Prod_Code, MN.Prod_Name Main_Prod_Name , BDL.Purchase_price, BDL.Packet_Qty, BDL.No_Of_Packets, BDL.Loca, Location.Loca_Descrip, 'Duplicate' Status,BDL.SellinPrice[Selling_Price],BDL.MCost_Price[MPurchase],BDL.MSelling_Price[MSelling] ,SUB.Prod_Code,SUB.Prod_Name,'DOCUMENT FROM  '+'" + txtCodeFrom.Text + " TO- '+'" + txtCodeTo.Text.Trim() + "'[CodeRange] FROM dbo.tbBudleProductIssueDetails BDL INNER JOIN Location ON BDL.Loca = Location.Loca JOIN dbo.Product MN ON BDL.Main_Prod_Code=Mn.Prod_Code JOIN dbo.Product SUB ON BDL.Prod_Code=sub.Prod_Code WHERE  Doc_No between '" + txtCodeFrom.Text + "' and '" + txtCodeTo.Text + "'  AND BDL.Loca = '" + LoginManager.LocaCode + "' And Iid='BDL' Order By Main_Prod_Code ASC";


                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT BDL.Doc_No, BDL.Post_Date, BDL.Main_Prod_Code, MN.Prod_Name Main_Prod_Name , BDL.Purchase_price, BDL.Packet_Qty, BDL.No_Of_Packets, BDL.Loca, Location.Loca_Descrip, 'Duplicate' Status,BDL.SellinPrice[Selling_Price],BDL.MCost_Price[MPurchase],BDL.MSelling_Price[MSelling] ,SUB.Prod_Code,SUB.Prod_Name,'DATE FROM  '+'" + dtDateFrom.Text + " TO- '+'" + dtDateTo.Text.Trim() + "'[CodeRange] FROM dbo.tbBudleProductIssueDetails BDL INNER JOIN Location ON BDL.Loca = Location.Loca JOIN dbo.Product MN ON BDL.Main_Prod_Code=Mn.Prod_Code JOIN dbo.Product SUB ON BDL.Prod_Code=sub.Prod_Code WHERE convert(datetime,Post_date,103) between convert(datetime,'" + dtDateFrom.Text + "',103) and convert(datetime,'" + dtDateTo.Text + "',103)  AND BDL.Loca = '" + LoginManager.LocaCode + "' And Iid='BDL' Order By Main_Prod_Code ASC";

                        }
                        objRepView.DataSetName = "dsPacketingProductNote";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        //   rptProductBundleingNoteSummary bundleSummary = new rptProductBundleingNoteSummary();
                        //bundleSummary.SetDataSource(dsDataForReport);
                        //objRepViewer.crystalReportViewer1.ReportSource = bundleSummary;
                        break;

                    case 253:
                        if (radioButtonDocumentNo.Checked)
                        {
                            objRepView.SqlStatement = "SELECT Transaction_Details.Prod_Code, Transaction_Details.Prod_Name, Code, Qty, FreeQty, Post_Date, Product.Prod_Name [To_LocaDesc], Doc_No,'DOCUMENT FROM  '+'" + txtCodeFrom.Text + " TO- '+'" + txtCodeTo.Text.Trim() + "'[CodeRange] FROM Transaction_Details INNER JOIN Product ON Code=Product.Prod_Code WHERE Loca='" + LoginManager.LocaCode + "' AND Doc_No between '" + txtCodeFrom.Text + "' and '" + txtCodeTo.Text + "' AND Iid='BIS' Order by Doc_No asc";

                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT Transaction_Details.Prod_Code, Transaction_Details.Prod_Name, Code, Qty, FreeQty, Post_Date, Product.Prod_Name [To_LocaDesc], Doc_No,'DATE FROM  '+'" + dtDateFrom.Text + " TO- '+'" + dtDateTo.Text.Trim() + "'[CodeRange] FROM Transaction_Details INNER JOIN Product ON Code=Product.Prod_Code WHERE Loca='" + LoginManager.LocaCode + "' AND convert(datetime,Post_date,103) between convert(datetime,'" + dtDateFrom.Text + "',103) and convert(datetime,'" + dtDateTo.Text + "',103) AND Iid='BIS' Order by Doc_No asc";
                        }
                        objRepView.DataSetName = "dsBulkIssue";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        rptBulkIssueSummary BulkIssueSumm = new rptBulkIssueSummary();
                        BulkIssueSumm.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = BulkIssueSumm;
                        break;
                    ...
                    case 200:
                        ...
                        if (objComman.Ads.Tables[3].Rows.Count>0 && Settings.Default.CRMMSg == true && MessageBox.Show("Do you want to Resend The SMS", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
                            if (frmWholeSaleInvoice.GetInvoice != null)
                            {
                                frmWholeSaleInvoice.GetInvoice.SendLoyalityMSGN(txtCodeFrom.Text);
                            }
                            else
                            {
                                frmWholeSaleInvoice.GetInvoice = new frmWholeSaleInvoice();
                                frmWholeSaleInvoice.GetInvoice.SendLoyalityMSGN(txtCodeFrom.Text);
                                frmWholeSaleInvoice.GetInvoice = null;
                            }
                            MainClass.mdi.Cursor = Cursors.Default;
                            return;
                        }
                    ...
                    case 202:
                        objRepView.SqlStatement = "SELECT Transaction_Header.Doc_no, Transaction_Header.Supplier_Id ,Supplier.Supp_Name, Transaction_Header.Loca,Location.Loca_Descrip, Transaction_Header.Post_Date, Transaction_Header.inv_no, ((Transaction_Details.Selling_Price*Transaction_Details.Qty)- (Transaction_Details.Purchase_Price*Transaction_Details.Qty))/(Transaction_Details.Purchase_Price * CASE Transaction_Details.Qty WHEN 0 THEN 1 ELSE Transaction_Details.QTY END)*100 Inv_Amt, Transaction_Header.Porder_no, Transaction_Header.Net_Amount,Transaction_Header.Amount Gross_Amount ,Transaction_Header.Discount Sub_Discount, Transaction_Header.Disc, Transaction_Header.Remarks, Transaction_Header.Reference, Transaction_Header.Pay_Type, Transaction_Header.Tax,Transaction_Details.Prod_code, Transaction_Details.Prod_Name,SA.SerialNo[Serial_No], Transaction_Details.Qty, Transaction_Details.FreeQty, Transaction_Details.Purchase_Price, Transaction_Details.Selling_Price, Transaction_Details.Discount, Transaction_Details.Amount, Transaction_Details.Ln, 'Duplicate' Status, Transaction_Header.User_Name, Transaction_Header.AccessUser, (case ISNUMERIC(Transaction_Details.Code) WHEN 1 THEN CONVERT(DECIMAL(10,3),Transaction_Details.Code) ELSE 0 END) AS Whole_Price,  (( (case ISNUMERIC(Transaction_Details.Code) WHEN 1 THEN CONVERT(DECIMAL(10,3), Transaction_Details.Code) ELSE 0 END)*Transaction_Details.Qty)- (Transaction_Details.Purchase_Price*Transaction_Details.Qty))/(Transaction_Details.Purchase_Price*case Transaction_Details.Qty when 0 then 1 else Transaction_Details.qty end)*100 Wh_Perr,Transaction_Details.VATAmount[Wh_Per],Transaction_Details.Batchno FROM Transaction_Header INNER JOIN Transaction_Details ON Transaction_Header.Doc_No = Transaction_Details.Doc_No AND Transaction_Header.Loca = Transaction_Details.Loca AND Transaction_Header.Iid = Transaction_Details.Iid INNER JOIN Location ON Transaction_Header.Loca = Location.Loca inner join supplier ON Transaction_Header.Supplier_Id = supplier.supp_code JOIN dbo.Product P ON P.Prod_Code = Transaction_Details.Prod_Code LEFT JOIN SerialNo_Apply SA ON SA.DocNo = Transaction_Details.Doc_No AND SA.ProdCode = Transaction_Details.Prod_Code WHERE Transaction_Header.Doc_No = '" + txtCodeFrom.Text.ToString() + "' AND Transaction_Header.Loca = '" + LoginManager.LocaCode + "' AND Transaction_Header.Iid = 'GRN' ORDER BY Ln;SELECT * FROM CompanyProfile";
                    ...
                    case 203:
                        objRepView.SqlStatement = "select Transaction_Header.Loca, Location.Loca_Descrip, Transaction_Header.Doc_No, Transaction_Header.Post_Date, Transaction_Header.[User_Name], Transaction_Details.Prod_Code, Transaction_Details.Prod_Name, Transaction_Details.Qty, Transaction_Details.Phy_Qty, Transaction_Details.Purchase_Price, Transaction_Details.Selling_Price, Transaction_Details.Pack_Size, Transaction_Details.Ln, 'Duplicate' Status,Transaction_Header.Remarks[Memo] FROM Transaction_Header INNER JOIN Transaction_Details ON Transaction_Header.Doc_no = Transaction_Details.Doc_no AND Transaction_Header.Loca = Transaction_Details.Loca AND Transaction_Header.Iid = Transaction_Details.Iid INNER JOIN Location ON Transaction_Header.Loca = Location.Loca WHERE Transaction_Header.doc_no = '" + txtCodeFrom.Text.ToString() + "' AND Transaction_Header.Loca = '" + LoginManager.LocaCode + "' AND Transaction_Header.Iid = 'STA' ORDER BY Ln";
                    ...
                    case 207:
                        ...
                        //else
                        //{
                        //    objRepView.SqlStatement = "SELECT Transaction_Header.Doc_no, Transaction_Header.Supplier_Id Cust_Code ,Customer.Cust_Name, Transaction_Header.Loca,Location.Loca_Descrip, Transaction_Header.Post_Date, Transaction_Header.inv_no, Transaction_Header.Inv_Amt, Transaction_Header.Porder_no, Transaction_Header.Net_Amount,Transaction_Header.Amount Gross_Amount ,Transaction_Header.Discount Sub_Discount, Transaction_Header.Disc, Transaction_Header.Remarks, Transaction_Header.Reference, Transaction_Header.Pay_Type, Transaction_Header.Tax, Ref_Name Sales_Assist,Transaction_Details.Prod_code, Transaction_Details.Prod_Name, Transaction_Details.Qty, Transaction_Details.FreeQty, Transaction_Details.Purchase_Price, Transaction_Details.Selling_Price, Transaction_Details.Discount, Transaction_Details.Amount, Transaction_Details.Ln, Transaction_Header.PayRemark1, Customer.Address1, Customer.Address2, Customer.Address3, Customer.Address4, 'Duplicate' Status FROM Transaction_Header INNER JOIN Transaction_Details ON Transaction_Header.Doc_No = Transaction_Details.Doc_No AND Transaction_Header.Loca = Transaction_Details.Loca AND Transaction_Header.Iid = Transaction_Details.Iid INNER JOIN Location ON Transaction_Header.Loca = Location.Loca INNER JOIN customer ON Transaction_Header.Supplier_Id = Customer.Cust_code INNER JOIN Product ON Product.Prod_Code=Transaction_Details.Prod_Code WHERE Transaction_Header.Doc_No = '" + txtCodeFrom.Text.ToString() + "' AND Transaction_Header.Loca = '" + LoginManager.LocaCode + "' AND Transaction_Header.Iid ='INV' AND Net_Amount<0 ORDER BY Ln;SELECT * FROM CompanyProfile";
                        //    objRepView.DataSetName = "dsInvoiceDetails";
                        //    objRepView.RetrieveData();
                        ...
                        objComman = new clsCommon();
                        objComman.SqlStatement = "EXEC dbo.Sp_printSingleReports @DocNo = '" + txtCodeFrom.Text.Trim() + "',@Loca = '" + LoginManager.LocaCode + "',@Iid = 'INV',@State = 'Duplicate' ";

                        ObjPrinterSelect = new FrmPrinterSelect();
                    ...
                    case 210: //Invoice Summary
                        ...
                        objRepView.SqlStatement = "EXEC dbo.Sp_GetReport  @Report = '210',@DateFrom = '" + dtDateFrom.Text + "',@DateTo = '" + dtDateTo.Text + "',@CodeFrom = '" + txtCodeFrom.Text + "',@CodeTo = '" + txtCodeTo.Text + "',@Loca = '" + LoginManager.LocaCode + "',@DateAll = '" + DateAll + "',@PayType='" + cmbtype.Text + "',@Unit ='" + cmbUnit.Text.Trim() + "'";
                    ...
                    case 211: //Customer Return Summary
                        if (radioButtonDocumentNo.Checked == true)
                        {
                            objRepView.SqlStatement = "select Transaction_Header.Iid, Transaction_Header.Doc_No, Transaction_Header.Loca, Location.Loca_Descrip, Transaction_Header.To_LocaDesc, Transaction_Header.Supplier_Id, Customer.Cust_Name Supp_Name, Transaction_Header.Post_Date, Transaction_Header.Discount,abs(Transaction_Header.Amount)Amount, abs(Transaction_Header.Net_Amount)Net_Amount,'Code From " + txtCodeFrom.Text.Trim() + "' CodeFrom, 'Code To " + txtCodeTo.Text.Trim() + "' CodeTo from Transaction_Header INNER JOIN Location ON Transaction_Header.Loca = Location.Loca INNER JOIN Customer ON Transaction_Header.Supplier_Id = Customer.Cust_Code WHERE Transaction_Header.Doc_No BETWEEN '" + txtCodeFrom.Text.ToString() + "' AND '" + txtCodeTo.Text.ToString() + "' AND Transaction_Header.Loca = '" + LoginManager.LocaCode + "' AND Transaction_Header.Iid = 'INV' AND Net_Amount<0 ORDER BY RIGHT(Doc_No,6)";
                        }
                        else
                        {
                            objRepView.SqlStatement = "select Transaction_Header.Iid, Transaction_Header.Doc_No, Transaction_Header.Loca, Location.Loca_Descrip, Transaction_Header.To_LocaDesc, Transaction_Header.Supplier_Id, Customer.Cust_Name Supp_Name, Transaction_Header.Post_Date, Transaction_Header.Discount,abs(Transaction_Header.Amount)Amount, abs(Transaction_Header.Net_Amount)Net_Amount, 'Date From " + dtDateFrom.Text.Trim() + "' CodeFrom, 'Date To " + dtDateTo.Text.Trim() + "' CodeTo from Transaction_Header INNER JOIN Location ON Transaction_Header.Loca = Location.Loca INNER JOIN Customer ON Transaction_Header.Supplier_Id = Customer.Cust_Code WHERE (CONVERT(DATETIME,Transaction_Header.Post_Date,103) BETWEEN CONVERT(DATETIME,'" + dtDateFrom.Text.Trim() + "',103) AND CONVERT(DATETIME,'" + dtDateTo.Text.Trim() + "', 103)) AND Transaction_Header.Loca = '" + LoginManager.LocaCode + "' AND Transaction_Header.Iid = 'INV' AND Net_Amount<0 ORDER BY RIGHT(Doc_No,6)";
                        }
                        objRepView.DataSetName = "TransactionSummary";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                    ...
                    case 216:
                        objRepView.SqlStatement = "SELECT Transaction_Header.Doc_no, Transaction_Header.Supplier_Id ,Supplier.Supp_Name, Transaction_Header.Loca,Location.Loca_Descrip, Transaction_Header.Post_Date, Transaction_Header.inv_no, Transaction_Header.Inv_Amt, Transaction_Header.Porder_no, Transaction_Header.Net_Amount,Transaction_Header.Amount Gross_Amount ,Transaction_Header.Discount Sub_Discount, Transaction_Header.Disc, Transaction_Header.Remarks, Transaction_Header.Reference, Transaction_Header.Pay_Type, Transaction_Header.Tax,Transaction_Details.Prod_code, Transaction_Details.Prod_Name, Transaction_Details.Qty, Transaction_Details.FreeQty, Transaction_Details.Purchase_Price, Transaction_Details.Selling_Price, Transaction_Details.Discount, Transaction_Details.Amount, Transaction_Details.Ln, 'Duplicate' Status, BatchNo, ExpDate,P.Barcode,Transaction_Details.Serial_No FROM Transaction_Header " +
                            "INNER JOIN Transaction_Details ON Transaction_Header.Doc_No = Transaction_Details.Doc_No AND Transaction_Header.Loca = Transaction_Details.Loca AND Transaction_Header.Iid = Transaction_Details.Iid INNER JOIN Location ON Transaction_Header.Loca = Location.Loca INNER JOIN supplier ON Transaction_Header.Supplier_Id = supplier.supp_code JOIN dbo.Product P ON P.Prod_Code = Transaction_Details.Prod_Code /* LEFT JOIN SerialNo_Apply SA ON SA.DocNo = Transaction_Header.Inv_No AND Transaction_Details.Prod_Code = SA.ProdCode */ WHERE Transaction_Header.Doc_No = '" + txtCodeFrom.Text.ToString() + "' AND Transaction_Header.Loca = '" + LoginManager.LocaCode + "' AND Transaction_Header.Iid = 'SRN' ORDER BY Ln;SELECT * FROM CompanyProfile";
                        objRepView.DataSetName = "dsGRNDetailsForRep";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        objRepView.TempResultSet.Tables["dsGRNDetailsForRep1"].TableName = "CompanyProfile";
                        ...
                        if (blResult == System.Windows.Forms.DialogResult.Yes)
                        {
                            if (File.Exists(@"..\DirectReports\rptSupplierReturnNote.rpt"))
                            {
                                objRepViewer.DirectPrintVerRep.Load(@"..\DirectReports\rptSupplierReturnNote.rpt");
                            }
                            else
                            {
                                objRepViewer.DirectPrintVerRep = new rptSupplierReturnNote();
                            }
                        }
                        else
                        {

                            if (File.Exists(@"..\DirectReports\rptSupplierReturnNoteSupp.rpt"))
                            {
                                objRepViewer.DirectPrintVerRep.Load(@"..\DirectReports\rptSupplierReturnNoteSupp.rpt");
                            }
                            else
                            {
                                objRepViewer.DirectPrintVerRep = new rptSupplierReturnNoteSupp();
                            }
                        }
                        objRepViewer.DirectPrintVerRep.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = objRepViewer.DirectPrintVerRep;
                    ...
                    case 231:
                        ...
                        rptAdvanceReport objadvanceCus = new rptAdvanceReport();

                        objRepView.SqlStatement = "EXEC [dbo].[Sp_printSingleReports]  @DocNo = '" + txtCodeFrom.Text + "',@Loca = '" + LoginManager.LocaCode + "',@Iid = 'CADV',@State = 'Duplicate' ";
                        objadvanceCus.SummaryInfo.ReportTitle = "Customer Advance Receipt";
                        ...
                        ObjPrinterSelect = new FrmPrinterSelect();
                        ObjPrinterSelect.ReportTitle = objadvanceCus.SummaryInfo.ReportTitle;
                        ObjPrinterSelect.dsForRep = dsDataForReport;
                        ObjPrinterSelect.IID = "ADV";
                        ObjPrinterSelect.Print = false;
                        ObjPrinterSelect.ShowDialog();
                    ...
                    case 256:
                        ...
                        rptAdvanceReport objadvanceSupp = new rptAdvanceReport();

                        objRepView.SqlStatement = "EXEC [dbo].[Sp_printSingleReports]  @DocNo = '" + txtCodeFrom.Text + "',@Loca = '" + LoginManager.LocaCode + "',@Iid = 'SADV',@State = 'Duplicate' ";
                        objadvanceSupp.SummaryInfo.ReportTitle = "Supplier Advance Voucher";
                        ...
                        ObjPrinterSelect = new FrmPrinterSelect();
                        ObjPrinterSelect.ReportTitle = objadvanceSupp.SummaryInfo.ReportTitle;
                        ObjPrinterSelect.dsForRep = dsDataForReport;
                        ObjPrinterSelect.IID = "ADV";
                        ObjPrinterSelect.Print = false;
                        ObjPrinterSelect.ShowDialog();
                    ...
                    case 233:
                        ...
                        objRepViewer.DirectPrintVerRep.Load(@"..\DirectReports\rptBulkIssue.rpt");
                        objRepViewer.DirectPrintVerRep.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = objRepViewer.DirectPrintVerRep;
                        break;

                    case 254:
                        objRepView.SqlStatement = "SELECT BDL.Doc_No, BDL.Post_Date, BDL.Main_Prod_Code, MN.Prod_Name Main_Prod_Name , BDL.Purchase_price, BDL.Packet_Qty, BDL.No_Of_Packets, BDL.Loca, Location.Loca_Descrip, 'Duplicate' Status,BDL.SellinPrice[Selling_Price],BDL.MCost_Price[MPurchase],BDL.MSelling_Price[MSelling] ,SUB.Prod_Code,SUB.Prod_Name FROM dbo.tbBudleProductIssueDetails BDL INNER JOIN Location ON BDL.Loca = Location.Loca JOIN dbo.Product MN ON BDL.Main_Prod_Code=Mn.Prod_Code JOIN dbo.Product SUB ON BDL.Prod_Code=sub.Prod_Code WHERE BDL.Doc_No = '" + txtCodeFrom.Text + "' AND BDL.Loca = '" + LoginManager.LocaCode + "' And Iid='BDL' Order By Main_Prod_Code ASC";
                        objRepView.DataSetName = "dsPacketingProductNote";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        rptProductBundleingNote Bundle = new rptProductBundleingNote();
                        Bundle.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = Bundle;
                        break;
                    ...
                    case 236://Cash Return Summary
                        ...
                        rptCashRetSummary.SummaryInfo.ReportTitle = "CASH REFUND SUMMARY";
                    ...
                    case 243:
                        ...
                        if (File.Exists(@"..\DirectReports\rptCashDeno.rpt"))
                        {
                            objRepViewer.DirectPrintVerRep.Load(@"..\DirectReports\rptCashDeno.rpt");
                        }
                        else
                        {
                    ...
                    case 250:
                        ...
                        break;
                    //Debtor open Balance details
                    case 251:
                        if (radioButtonDocumentNo.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT DB.Loca,L.Loca_Descrip,DB.DocNo,C.Cust_Code[Acc_Code],C.Cust_Name[Acc_Name],DB.PostDate[Date],DB.Amount,DB.Reference[Refference],DB.InsertDate,DB.InsertUser[UserName],'CODE FROM -'+'" + txtCodeFrom.Text.Trim() + "'+'TO -'+'" + txtCodeTo.Text.Trim() + "'[DateRange] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Customer C ON C.Cust_Code=DB.CutId WHERE DB.DocNo BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "'   AND DB.Loca='" + LoginManager.LocaCode + "' order by DocNo asc ";
                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT DB.Loca,L.Loca_Descrip,DB.DocNo,C.Cust_Code[Acc_Code],C.Cust_Name[Acc_Name],DB.PostDate[Date],DB.Amount,DB.Reference[Refference],DB.InsertDate,DB.InsertUser[UserName],'DATE FROM -'+'" + dtDateFrom.Text.Trim() + "'+'TO -'+'" + dtDateTo.Text.Trim() + "'[DateRange] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Customer C ON C.Cust_Code=DB.CutId WHERE CONVERT(DATETIME,DB.PostDate,103) BETWEEN CONVERT(DATETIME,'" + dtDateFrom.Text + "',103) AND CONVERT(DATETIME,'" + dtDateTo.Text + "',103)  AND DB.Loca='" + LoginManager.LocaCode + "' order by DocNo asc ";
                        }

                        objRepView.DataSetName = "dtOpenBalanceDetails";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        rptOpenBalnceSummary openBalace = new rptOpenBalnceSummary();
                        openBalace.SetDataSource(dsDataForReport);
                        openBalace.SummaryInfo.ReportTitle = "DEBTOR OPEN BALANCE SUMMARY";
                        objRepViewer.crystalReportViewer1.ReportSource = openBalace;
                    ...
                    case 252:
                        if (radioButtonDocumentNo.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT DB.Loca,L.Loca_Descrip,DB.DocNo,C.Supp_Code[Acc_Code],C.Supp_Name[Acc_Name],DB.PostDate[Date],DB.Amount,DB.Reference[Refference],DB.InsertDate[CreateDate],DB.InsertUser[UserName],'CODE FROM -'+'" + txtCodeFrom.Text.Trim() + "'+'TO -'+'" + txtCodeTo.Text.Trim() + "'[DateRange] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Supplier C ON C.Supp_Code=DB.CutId WHERE DB.DocNo BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "'   AND DB.Loca='" + LoginManager.LocaCode + "' order by DocNo asc ";
                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT DB.Loca,L.Loca_Descrip, DB.DocNo,C.Supp_Code[Acc_Code],C.Supp_Name[Acc_Name],DB.PostDate[Date],DB.Amount,DB.Reference[Refference],DB.InsertDate[CreateDate],DB.InsertUser[UserName],'DATE FROM -'+'" + dtDateFrom.Text.Trim() + "'+'TO -'+'" + dtDateTo.Text.Trim() + "'[DateRange] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Supplier C ON C.Supp_Code=DB.CutId WHERE CONVERT(DATETIME,DB.PostDate,103) BETWEEN CONVERT(DATETIME,'" + dtDateFrom.Text + "',103) AND CONVERT(DATETIME,'" + dtDateTo.Text + "',103)  AND DB.Loca='" + LoginManager.LocaCode + "' order by DocNo asc ";
                        }

                        objRepView.DataSetName = "dtOpenBalanceDetails";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        rptOpenBalnceSummary openBalaceCrd = new rptOpenBalnceSummary();
                        openBalaceCrd.SetDataSource(dsDataForReport);
                        openBalaceCrd.SummaryInfo.ReportTitle = "CREDITOR OPEN BALANCE SUMMARY";
                        objRepViewer.crystalReportViewer1.ReportSource = openBalaceCrd;

                        break;

                    case 262:
                        objRepView.SqlStatement = "Exec dbo.Sp_printSingleReports @DocNo='" + txtCodeFrom.Text.Trim() + "',@Loca='" + LoginManager.LocaCode + "',@Iid='JOB',@State ='Duplicate' ";
                        objRepView.DataSetName = "dsJobApply";
                        objRepView.RetrieveData();
                        dsDataForReport = objRepView.TempResultSet;
                        dsDataForReport.Tables[1].TableName = "JobDetail";
                        dsDataForReport.Tables[2].TableName = "CompanyProfile";
                        rptJobRegistrationRpt rptJobReg = new rptJobRegistrationRpt();
                        rptJobReg.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = rptJobReg;
                        break;
        ...
        private void btnDocumentTo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                switch (intRepOption)
                {
                    ...
                    case 231:   //Advance Report
                        strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='CADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%" + txtCodeTo.Text.Trim() + "%' ORDER BY Org_Doc_no DESC";

                        break;
                    case 257:

                        strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='CADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%"+txtCodeTo.Text.Trim()+"%' ORDER BY Org_Doc_no ASC";

                        break;
                    case 256:   //Advance Report
                        strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='SADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%" + txtCodeTo.Text.Trim() + "%' ORDER BY Org_Doc_no DESC";
                        break
                            ;
                    case 258:

                        strQuery = "SELECT DISTINCT Org_Doc_no [Document NO],Post_Date [Post Date] FROM tbPaidPaymentSummary WHERE Iid='SADV' AND Loca='" + LoginManager.LocaCode + "' and Org_Doc_no like '%" + txtCodeTo.Text.Trim() + "%' ORDER BY Org_Doc_no ASC";
                    ...
                    case 255:
                        ...
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' AND Doc_No='" + txtCodeTo.Text + "' Order by Doc_No asc";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' Order by Doc_No asc";
                    ...
                    case 254:   //Bundle
                        if (txtCodeTo.Text.Trim() != string.Empty)
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' AND Doc_No='" + txtCodeTo.Text + "' Order by Doc_No desc";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No[Document No],Post_Date[Date] FROM dbo.tbBudleProductIssueDetails WHERE iid='BDL' AND Loca='" + LoginManager.LocaCode + "' Order by Doc_No desc";
                    ...
                    case 233:   //Combination
                        if (txtCodeTo.Text.Trim() != string.Empty)
                        {
                            strQuery = "SELECT Doc_No, Post_Date FROM Transaction_Header WHERE Iid='BIS' AND Loca='" + LoginManager.LocaCode + "' AND Doc_No='" + txtCodeTo.Text + "' Order by Doc_No desc";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No, Post_Date FROM Transaction_Header WHERE Iid='BIS' AND Loca='" + LoginManager.LocaCode + "' Order by Doc_No desc";
                    ...
                    case 251: //Stock Adjustment
                        strQuery = "SELECT DB.DocNo,C.Cust_Name[Acc_Name],DB.PostDate[Date] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Customer C ON C.Cust_Code=DB.CutId WHERE DB.DocNo LIKE  '%" + txtCodeTo.Text.Trim() + "%'  AND DB.Loca='" + LoginManager.LocaCode + "' ORDER BY RIGHT(DocNo,6) DESC";

                        break;

                    case 252: //Stock Adjustment
                        strQuery = "SELECT DB.DocNo ,C.Supp_Name[Acc_Name],DB.PostDate[Date] FROM dbo.tb_DebtorBalance DB JOIN dbo.Location L ON L.Loca = DB.Loca JOIN dbo.Supplier C ON C.Supp_Code=DB.CutId  WHERE DB.DocNo LIKE  '%" + txtCodeTo.Text.Trim() + "%'  AND DB.Loca='" + LoginManager.LocaCode + "' ORDER BY RIGHT(DocNo,6) DESC";
                    ...
                    case 211: //Customer Return Summary
                        if (txtCodeTo.Text.Trim()!=string.Empty )
                        {
                            strQuery = "SELECT Doc_No [Document No], Post_Date [Doc Date] FROM Transaction_Header WHERE Iid = 'INV' AND Net_Amount<0  AND Loca = '" + LoginManager.LocaCode + "' AND Doc_No LIKE '%'+'" + txtCodeTo.Text.Trim() + "'+'%' ORDER BY RIGHT(Doc_No,6)";
                        }
                        else
                        {
                            strQuery = "SELECT Doc_No [Document No], Post_Date [Doc Date] FROM Transaction_Header WHERE Iid = 'INV' AND Net_Amount<0 AND Loca = '" + LoginManager.LocaCode + "' ORDER BY RIGHT(Doc_No,6)";
