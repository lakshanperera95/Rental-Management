            ...
            try
            {
                ...
                try
                {
                    while ((input = m_streamReader.ReadLine()) != null)
                    {
                        ...
                        {
                            strReadServerName = input.Trim().Substring(2, input.Trim().Length - 2);
                        ...
                        {
                            strReadPassword = input.Trim().Substring(2, input.Trim().Length - 2);
                        ...
                        {
                            LoginManager.ApiReward = input.Trim().Substring(2, input.Trim().Length - 2);
                        }
