...
{
    public class clsPurchaseOrder : clsPublic
    {
        ...
        {
            get { return strExpectedDate; }
            set { strExpectedDate = value; }
        }
        ...
        {
            get { return strShiftToHeader; }
            set { strShiftToHeader = value; }
        }

        public string ShiftAddress1
        {
            get { return strShiftAddress1; }
            set { strShiftAddress1 = value; }
        }

        public string ShiftAddress2
        {
            get { return strShiftAddress2; }
            set { strShiftAddress2 = value; }
        }
        ...
        {
            get { return intCreditPeriod; }
            set { intCreditPeriod = value; }
        }
        ...
        public void GetTempDocumentNo()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    strTempDocumentNo = "PON" + LoginManager.LocaCode.Trim().Substring(0, 2) + strTempDocumentNo;
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 001. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 002. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetTempDataset()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 003. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetItemDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 004. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetSupplierDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 005. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadProductDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 006. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadTempTransDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 008. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadExsistProductDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 009. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void UpdatePonTempDataSet()
        {
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@User_Name", SqlDbType.NVarChar, 30, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.UserName.ToString()));
                command.ExecuteNonQuery();
                command.UpdatedRowSource = UpdateRowSource.OutputParameters;
                ErrorCode = (int)(command.Parameters["@Err_x"].Value);
            }
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 010. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetTotalValues()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 011. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetOrgDocumentNo()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 012. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void PurchaseOrderNoteApply()
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@Expected_Date", SqlDbType.NVarChar, 15, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strExpectedDate));
                ...
                da.Fill(GetReportDataset = new DataSet(), "dsPurchaseOrderDetails");
                command.UpdatedRowSource = UpdateRowSource.OutputParameters;
                ErrorCode = (int)(command.Parameters["@Err_x"].Value);
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 013. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetDataSetForReport()
        {
            try
            {
                dsForReport = dbcon.getDataset("SELECT Transaction_Header.Doc_No, Transaction_Header.Post_Date, Transaction_Header.Supplier_Id, Supplier.Supp_Name, Transaction_Header.Pay_Type, Transaction_Header.Remarks, Transaction_Header.Expected_Date, Transaction_Header.AddRemarks, Transaction_Header.Reference, Transaction_Header.PayRemark1, Transaction_Header.PayRemark2, Transaction_Header.Tax, Transaction_Details.Prod_Code, Transaction_Details.Prod_Name, Transaction_Details.Qty, Transaction_Details.Purchase_Price, Transaction_Details.Selling_Price, Transaction_Details.Amount, Transaction_Details.Ln, Supplier.Address1, Supplier.Address2, Supplier.Address3, Supplier.Address4, Supplier.Tel, Supplier.Fax, Transaction_Header.Net_Amount, Transaction_Header.Pay1, 'Original' Status from Transaction_Header INNER JOIN Transaction_Details ON Transaction_Header.Doc_No = Transaction_Details.Doc_No AND Transaction_Header.Loca = Transaction_Details.Loca AND Transaction_Header.Iid = Transaction_Details.Iid INNER JOIN Supplier ON Transaction_Header.Supplier_Id = Supplier.Supp_Code WHERE Transaction_Header.IId = 'PON' AND Transaction_Header.Doc_No = '" + strOrgDocNo + "' AND Transaction_Header.Loca = " + LoginManager.LocaCode, "dsPurchaseOrderDetails");
            }
            catch (Exception e)
            {
                //Write to Log
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 014. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetDataSetForPreviewReport()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 015. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void DeleteProductDetaile()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 016. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void PurchaseOrderNoteSave()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 017. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadSavedDocument()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    intCreditPeriod = DataReader.GetOrdinal("Pay1");
                    decTax = (decimal)DataReader["Tax"];
                    strContactPerson = DataReader["AddRemarks"].ToString().Trim();
                    strShiftToHeader = DataReader["Reference"].ToString().Trim();
                    strShiftAddress1 = DataReader["PayRemark1"].ToString().Trim();
                    strShiftAddress2 = DataReader["PayRemark2"].ToString().Trim();
                    strExpectedDate = DataReader["Expected_Date"].ToString().Trim();
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 018. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
            ...
            if (blRecordFound == true)
            {
                ...
                catch (Exception e)
                {
                    ...
                    try
                    {
                        m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 019. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                        // read from file or write to file
                    }
                    finally
                    {
        ...
        public void SelectReOrderProductDetaile()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsPurchaseOrder 020. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
