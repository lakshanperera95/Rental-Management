...
#region "Passing SQL Statement for Retrieving"
        ...
        public void UpdateData(Control clearControl,Control focusControl)
        {
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@Curr_Loca", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.Location));
