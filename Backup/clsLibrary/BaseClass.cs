...
namespace clsLibrary
{
    public class BaseClass
    {
        ...
        private string _strCharecter;
        public string strCharecter {
            get { return _strCharecter; }
            set { _strCharecter = value; }
        }
        private string _strVoucherId;
        public string strVoucherId
        {
            get { return _strVoucherId; }
            set { _strVoucherId = value; }
        }
        private int _decId;
        public int decId
        {
        ...
        public void UpdateVoucher()
        {
            try
            {
                ...
                command.CommandText = "gif_sp_UpdatePrintVoucher";
                ...
                command.Parameters.Add(new SqlParameter("@BookNo", SqlDbType.NVarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strBookNo));
                command.Parameters.Add(new SqlParameter("@VoucherFrom", SqlDbType.NVarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, CodeMin));
                command.Parameters.Add(new SqlParameter("@VoucherTo", SqlDbType.NVarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, CodeMax));
                command.Parameters.Add(new SqlParameter("@VoucherType", SqlDbType.NVarChar, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, VoucherType));
                command.Parameters.Add(new SqlParameter("@Prit_User", SqlDbType.NVarChar, 30, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.UserName));
