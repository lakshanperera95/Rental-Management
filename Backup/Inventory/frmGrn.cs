            ...
            try
            {
                ...
                if (MessageBox.Show("Do you want to Apply This Document. ", "Goods Received Note", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (Settings.Default.TrInCon)
                    {
                        ...
                        else if (File.Exists(@"..\DirectReports\rptGoodReceivedNote.rpt"))
                        {
                    ...
                    else
                    {
                        ...
                        //objRepViewer.OtherReport = new rptGoodReceivedNote();
                        objRepViewer.DirectPrintVerRep.SetDataSource(dsDataForReport);
                        objRepViewer.crystalReportViewer1.ReportSource = objRepViewer.DirectPrintVerRep;
                        objRepViewer.Show();
                    }
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        objRepViewer.OtherReport = new rptGoodReceivedNoteWithSelprice();
                    }
                    objRepViewer.OtherReport = new rptGoodReceivedNote();
                    objRepViewer.OtherReport.SetDataSource(dsDataForReport);
                    objRepViewer.crystalReportViewer1.ReportSource = objRepViewer.OtherReport;
                    objRepViewer.Show();
                }
                ...
                //    if (MessageBox.Show("Do you want to display Selling Price?", this.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                //    {
                //        objRepViewer.DirectPrintVerRep.ReportDefinition.Sections["Section3"].ReportObjects["SellingPrice1"].ObjectFormat.EnableSuppress = false;
                //    }
                //    else
                //    {
                //        objRepViewer.DirectPrintVerRep.ReportDefinition.Sections["Section3"].ReportObjects["SellingPrice1"].ObjectFormat.EnableSuppress = true;
                //    }
                //    objRepViewer.Show();
                //}
                //else
                ...
                //    //rptGoodReceivedNoteWithSelprice rptGrn = new rptGoodReceivedNoteWithSelprice();
