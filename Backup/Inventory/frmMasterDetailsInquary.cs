            ...
            try
            {
                ...
                switch (intRepOption)
                {
                    ...
                    case 8:
                        if (rbByCode.Checked == true)
                        {
                            objRepView.SqlStatement = "select Sale_Code, Sale_Name, Area_Code, Address1, Address2, Address3, Address4, Tel, Fax, Email, Sales_Target, Vehicle_No, NIC from tb_salesman WHERE Sale_Code Between '" + txtCodeFrom.Text.Trim() + "' and '" + txtCodeTo.Text.Trim() + "' Order By Sale_Code ASC";
                        }
                        else
                        {
                            objRepView.SqlStatement = "select Sale_Code, Sale_Name, Area_Code, Address1, Address2, Address3, Address4, Tel, Fax, Email, Sales_Target, Vehicle_No, NIC from tb_salesman WHERE Sale_Code Between '" + txtCodeFrom.Text.Trim() + "' and '" + txtCodeTo.Text.Trim() + "' Order By Sale_Name ASC";
                        }
                    ...
                    case 59:
                        ...
                        if (rbByCode.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price,Product.Department_Id, Department.Dept_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Department ON Department.Dept_Code = Product.Department_Id WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Prod_Code BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Code ASC";
                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price,Product.Department_Id, Department.Dept_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Department ON Department.Dept_Code = Product.Department_Id WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Prod_Code BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Name ASC";
                        }
                    ...
                    case 60:
                        ...
                        if (rbByCode.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price, Product.Department_Id, Department.Dept_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Department ON Department.Dept_Code = Product.Department_Id  WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Department_Id BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Code ASC";
                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price, Product.Department_Id, Department.Dept_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Department ON Department.Dept_Code = Product.Department_Id  WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Department_Id BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Name ASC";
                        }
                    ...
                    case 61:
                        ...
                        if (rbByCode.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price, Product.Category_Id, Category.Cat_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Category ON Category.Cat_Code = Product.Category_Id  WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Category_Id BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Code ASC";
                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price, Product.Category_Id, Category.Cat_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Category ON Category.Cat_Code = Product.Category_Id  WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Category_Id BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Name ASC";
                        }
                    ...
                    case 62:
                        ...
                        if (rbByCode.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price, Product.Supplier_Id, Supplier.Supp_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Supplier ON Supplier.Supp_Code = Product.Supplier_Id  WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Supplier_Id BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Code ASC";
                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT Product.Prod_Code ,Product.Prod_Name,Product.Purchase_Price, Product.Selling_Price, Product.Supplier_Id, Supplier.Supp_Name, Stock_Master.Qty , Stock_Master.Loca,Location.Loca_Descrip,'" + txtCodeFrom.Text.Trim() + "' AS CodeFrom,'" + txtCodeTo.Text.Trim() + "'AS CodeTo FROM  PRODUCT INNER JOIN Stock_Master ON PRODUCT.Prod_Code = Stock_Master.Prod_Code INNER JOIN Location ON Stock_Master.Loca = Location.Loca INNER JOIN Supplier ON Supplier.Supp_Code = Product.Supplier_Id  WHERE Stock_Master.Loca = " + LoginManager.LocaCode + " AND Product.Supplier_Id BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' ORDER BY Product.Prod_Name ASC";
                        }
                    ...
                    case 83:
                        if (rbByCode.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT '" + txtCodeFrom.Text.Trim() + "' CodeFrom, '" + txtCodeTo.Text.Trim() + "' CodeTo, Product.Prod_Code, Product.Prod_Name, ROL Purchase_Price, RO_Qty Selling_Price, (RO_Qty-Stock_Master.Qty) AS Or_Qty, Stock_Master.Qty AS Pur_Qty,SUM(ProductSalesSummery.Qty)Sel_QTY FROM Stock_Master INNER JOIN Product ON Stock_Master.Prod_Code = Product.Prod_Code INNER JOIN ProductSalesSummery ON Product.Prod_Code = ProductSalesSummery.Prod_Code WHERE Product.Prod_Code BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' AND Stock_Master.Loca='" + LoginManager.LocaCode + "'  AND (RO_Qty-Stock_Master.Qty)>0 GROUP BY Product.Prod_Code, Product.Prod_Name, ROL, RO_Qty, Stock_Master.Qty Order by Or_Qty DESC,Product.Prod_Code ASC";

                        }
                        else
                        {
                            objRepView.SqlStatement = "SELECT '" + txtCodeFrom.Text.Trim() + "' CodeFrom, '" + txtCodeTo.Text.Trim() + "' CodeTo, Product.Prod_Code, Product.Prod_Name, ROL Purchase_Price, RO_Qty Selling_Price, (RO_Qty-Stock_Master.Qty) AS Or_Qty, Stock_Master.Qty AS Pur_Qty,SUM(ProductSalesSummery.Qty)Sel_QTY FROM Stock_Master INNER JOIN Product ON Stock_Master.Prod_Code = Product.Prod_Code INNER JOIN ProductSalesSummery ON Product.Prod_Code = ProductSalesSummery.Prod_Code WHERE Product.Prod_Code BETWEEN '" + txtCodeFrom.Text.Trim() + "' AND '" + txtCodeTo.Text.Trim() + "' AND Stock_Master.Loca='" + LoginManager.LocaCode + "'  AND (RO_Qty-Stock_Master.Qty)>0 GROUP BY Product.Prod_Code, Product.Prod_Name, ROL, RO_Qty, Stock_Master.Qty Order by Or_Qty DESC,Product.Prod_Name ASC";
                    ...
                    case 84:
                        if (rbByCode.Checked == true)
                        {
                            objRepView.SqlStatement = "SELECT '" + txtCodeFrom.Text.Trim() + "' CodeFrom, '" + txtCodeTo.Text.Trim() + "' CodeTo, Product.Prod_Code, Product.Prod_Name, Reorder_Level Purchase_Price, Reorder_Qty Selling_Price, (Reorder_Qty-Stock_Master.Qty) AS Or_Qty, Stock_Master.Qty AS Pur_Qty, SUM(ProductSalesSummery.Qty)Sel_QTY, Supplier_Id+' '+Supp_Name Dept_Code FROM Stock_Master INNER JOIN Product ON Stock_Master.Prod_Code = Product.Prod_Code INNER JOIN ProductSalesSummery ON Product.Prod_Code = ProductSalesSummery.Prod_Code INNER JOIN Supplier ON Supplier_Id=Supp_Code WHERE Product.Supplier_Id BETWEEN '" + txtCodeFrom.Text + "' AND '" + txtCodeTo.Text + "' AND Stock_Master.Loca='" + LoginManager.LocaCode + "'  AND (Reorder_Qty-Stock_Master.Qty)>0 GROUP BY Product.Prod_Code, Product.Prod_Name, Reorder_Level, Reorder_Qty, Stock_Master.Qty, Supplier_Id, Supp_Name Order by Or_Qty DESC,Supplier_Id,Product.Prod_Code ASC";
