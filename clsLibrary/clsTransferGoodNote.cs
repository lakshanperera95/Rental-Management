...
{
    public class clsTransferGoodNote : clsPublic
    {
        ...
        public void ReadFromLocationCode()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 001. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
        ...
        public void GetTempDocumentNo()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    strTempDocumentNo = "TOG" + LoginManager.LocaCode.Trim().Substring(0, 2) + strTempDocumentNo;
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 002. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetTempDataset()
        {
            try
            {
                ...
                dsTempTransferNote = dbcon.getDataset("SELECT Prod_Code, Prod_Name, Selling_Price, Purchase_price, Pack_Size, Qty, Amount,BatchNo FROM TransactionTemp_Details WHERE Doc_No = '" + strTempDocumentNo + "' AND IId = 'TGN' AND Loca = " + LoginManager.LocaCode + " Order by Ln", "TransferNote");
            }
            catch (Exception e)
            {
                //Write to Log
        ...
        public void GetItemDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 005. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadToLocationCode()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 006. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadProductDetails()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    unit = DataReader["Unit"].ToString().Trim();
                }
                else
                {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 007. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadExsistProductDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 008. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void UpdateTransferNoteTempDataSet()
        {
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@BatchNo", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, BatchNo));
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 009. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetTotalValues()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 010. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetOrgDocumentNo()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 011. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void TransferNoteApply()
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@To_LocaDesc", SqlDbType.NVarChar, 200, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strToLocaName));
                ...
                command.Parameters.Add(new SqlParameter("@GrnNo", SqlDbType.NVarChar, 12, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strRecallSaveDocNo));
                ...
                da.Fill(GetReportDataset = new DataSet(), "dsTogDetails");
                GetReportDataset.Tables["dsTogDetails1"].TableName = "CompanyProfile";
                command.UpdatedRowSource = UpdateRowSource.OutputParameters;
                ErrorCode = (int)(command.Parameters["@Err_x"].Value);
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 012. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetDataSetForReport()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 013. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void DeleteProductDetaile()
        {
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@Iid", SqlDbType.NVarChar, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, "TGN"));
                command.Parameters.Add(new SqlParameter("@Prod_Code", SqlDbType.NVarChar, 25, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strProductCode));
                command.Parameters.Add(new SqlParameter("@BatchNo", SqlDbType.VarChar, 25, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, BatchNo));
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 014. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadTempTransDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 015. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetDataSetForPreview()
        {
            ...
            {
                strPostDate = string.Format("{0:dd/MM/yyyy}", PostDate);
                dsForReport = dbcon.getDataset("SELECT TTD.doc_no, TTD.Loca, '" + strLocaName + "' LocaDesc, '" + strToLocaCode + "' To_Loca, '" + strToLocaName + "' To_LocaDesc, '" + strPostDate + "' Post_Date, '" + strRemark + "' Remarks, TTD.Prod_Code, TTD.Prod_Name, TTD.Qty, TTD.Purchase_Price, TTD.Selling_Price, TTD.Pack_Size, TTD.Amount,'Temporary' Status, P.Unit FROM TransactionTemp_Details TTD INNER JOIN Product P ON TTD.Prod_Code = P.Prod_Code WHERE TTD.doc_no = '" + strTempDocumentNo + "' AND TTD.Loca = '" + LoginManager.LocaCode + "' AND TTD.Iid = 'TGN' ORDER BY Ln", "dsTogDetails");
            }
            catch (Exception e)
            {
                //Write to Log
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 016. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void TransferNoteSave()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 017. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ReadSavedDocument()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    strToLocaCode = DataReader["To_Loca"].ToString().Trim();
                    strToLocaName = DataReader["Loca_Descrip"].ToString().Trim();
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 018. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
            ...
            if (blRecordFound == true)
            {
                ...
                catch (Exception e)
                {
                    ...
                    try
                    {
                        m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsTransferGoodNote 019. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                        // read from file or write to file
                    }
                    finally
                    {
        ...
        public void GrnIntoTgn()
        {
            try
            {
                ...
                command.Connection = dbcon.connection;
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "GrnIntoTgn";
                command.Parameters.Clear();
                command.Parameters.Add(new SqlParameter("@TempTogNo", SqlDbType.NVarChar, 12, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strTempDocumentNo));
                command.Parameters.Add(new SqlParameter("@GrnNo", SqlDbType.NVarChar, 12, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strRecallSaveDocNo));
                ...
                command.Parameters.Add(new SqlParameter("@UserName", SqlDbType.NVarChar, 30, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.UserName.Trim().ToUpper()));
                SqlDataAdapter da = new SqlDataAdapter(command);
                da.Fill(GetItemDataset = new DataSet());
            }
            finally
            {
                dbcon.connection.Close();
