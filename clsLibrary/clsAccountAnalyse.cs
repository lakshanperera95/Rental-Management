...
namespace clsLibrary
{
    public class clsAccountAnalyse
    {
        ...
        public string Cust_CodeTo { get; set; }
        ...
        public void ReadCustomerDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsAccountAnalyse 001. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
        ...
        public void GetCustomerDetails()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsAccountAnalyse 002. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetDetailsForDisplay()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsAccountAnalyse 003. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
