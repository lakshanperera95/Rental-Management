...
namespace clsLibrary
{
    ...
    #region Properties
        ...
        public string AlloWRedeem { get; set; }
        #endregion
        ...
        public void ReadCustomerDetails()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    CusType = DataReader["CusType"].ToString();
                    FileNo = DataReader["FileNo"].ToString();
                    AlloWRedeem = DataReader["AllowRed"].ToString();
        ...
        public void CustomerUpdate()
        {
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@CLoca", SqlDbType.VarChar, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.LocaCode));
                command.Parameters.Add(new SqlParameter("@Age", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, Age));
                command.Parameters.Add(new SqlParameter("@CusType", SqlDbType.VarChar, 250, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, CusType));
                command.Parameters.Add(new SqlParameter("@FileNo", SqlDbType.VarChar, 250, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, FileNo));
                command.Parameters.Add(new SqlParameter("@AllowAddRedeem", SqlDbType.VarChar, 10, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, AlloWRedeem));
        ...
        public void GetCusCode(string Custype)
        {
            try
            {
                ...
                strCusCode = string.Format("{0:0000}", Code);
