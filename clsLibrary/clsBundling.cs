    ...
    public class clsBundling : clsValidation
    {
        ...
        public void UpdateTempBundling(bool InsertToShowroom)
        {
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@MacAddress", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 3, 0, "", DataRowVersion.Default, LoginManager.MacAddress));
        ...
        public void GetBundleTempDataset()
        {
            ...
            {
                //get Temporary DataSet For Grn
                dsTempSelectedItem = dbcon.getDataset("select Prod_Code, Prod_Name, Purchase_price ,Packet_Qty FROM tbTempBundleProductDetails where MacAddres='" + LoginManager.MacAddress+"'", "dsTempPacketProduct");
            }
            catch (Exception e)
            {
                //Write to Log
       ...
       /*         if (InsertToShowroom)
        ...
        public void DeleteTempPacketingProduct(string Sp, bool InsertToShowroom)
        {
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@Err_x", SqlDbType.Int, 0, ParameterDirection.InputOutput, false, 0, 0, "", DataRowVersion.Default, intErrCode));
                command.Parameters.Add(new SqlParameter("@Prod_Code", SqlDbType.NVarChar, 25, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strProductCode));
                command.Parameters.Add(new SqlParameter("@MacAddress", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.MacAddress));
