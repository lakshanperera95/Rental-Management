    ...
    public class clsStockOverwrite
    {
        ...
        public void GetProduct()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 001. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
        ...
        public void ReadProductDetails()
        {
            try
            {
                ...
                while (DataReader.Read())
                {
                    try
                    {
                        ...
                        strProductCode = DataReader[0].ToString().Trim();
                        strProductName = DataReader[1].ToString().Trim();
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 002. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void UpdateStockAdjustDataSet()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 003. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetTempDataset()
        {
            try
            {
                ...
                dsTempStockAdjust = dbcon.getDataset("SELECT Prod_Code, Prod_Name, Selling_Price, Purchase_price, Pack_Size, Qty  Curr_qty, Phy_Qty, (Phy_Qty - Qty) Var_Qty,BatchNo FROM TransactionTemp_Details WHERE Doc_No = '" + strTempDocumentNo + "' AND IId = 'STA' AND Loca = " + LoginManager.LocaCode + " Order by Prod_Code", "StockAdjust");
            }
            catch (Exception e)
            {
                //Write to Log
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 004. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetTotalValues()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 005. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetTempDocumentNo()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    strTempDocumentNo = string.Format("{0:000000}", intTempDocNo);
                        ...
                        strTempDocumentNo = "SOW" + LoginManager.LocaCode.Trim().Substring(0, 2) + strTempDocumentNo;
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 006. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 007. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetOrgDocumentNo()
        {
            try
            {
                ...
                if (DataReader.Read())
                {
                    ...
                    strOrgDocNo = "SOW" + LoginManager.LocaCode.Trim().Substring(0, 2) + strOrgDocNo;
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 008. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void StockAdjustApply()
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@Overight",1));
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 009. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void GetDataSetForReport()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 010. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void DeleteProductDetaile()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 011. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void DataForGrid()
        {
            ...
            catch (Exception e)
            {
                ...
                try
                {
                    m_streamWriter.WriteLine("Date/Time :' " + string.Format("{0:dd/MM/yyyy HH:mm:ss}", dtCurrentDate) + "'clsStockOvewrite 012. Error Description " + e.Message + " 'Location :' " + LoginManager.LocaCode + " 'User Name :' " + LoginManager.UserName.Trim() + " '");
                    // read from file or write to file
                }
                finally
                {
        ...
        public void ImportData()
        {
            try
            {
                ...
                command.Connection = dbcon.connection;
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "sp_StOverwrite_ImportData";
                command.Parameters.Clear();
                command.Parameters.Add(new SqlParameter("@Err_x", SqlDbType.Int, 0, ParameterDirection.InputOutput, false, 0, 0, "", DataRowVersion.Default, intErrCode));
                command.Parameters.Add(new SqlParameter("@Loca", SqlDbType.VarChar, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.LocaCode));
        ...
        public void ImportTextData()
        {
            try
            {
                ...
                command.Connection = dbcon.connection;
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "sp_StOverwrite_ImportTextData";
                command.Parameters.Clear();
                command.Parameters.Add(new SqlParameter("@Err_x", SqlDbType.Int, 0, ParameterDirection.InputOutput, false, 0, 0, "", DataRowVersion.Default, intErrCode));
                command.Parameters.Add(new SqlParameter("@Loca", SqlDbType.VarChar, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.LocaCode));
        ...
        public void SelectStockData()
        {
            try
            {
                ...
                command.Connection = dbcon.connection;
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = "sp_StOverwrite_SelectData";
                command.Parameters.Clear();
                command.Parameters.Add(new SqlParameter("@Err_x", SqlDbType.Int, 0, ParameterDirection.InputOutput, false, 0, 0, "", DataRowVersion.Default, intErrCode));
                command.Parameters.Add(new SqlParameter("@DocNo", SqlDbType.VarChar, 15, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strTempDocumentNo));
                ...
                command.Parameters.Add(new SqlParameter("@Code", SqlDbType.VarChar, 15, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, strCode));
                command.Parameters.Add(new SqlParameter("@Loca", SqlDbType.VarChar, 5, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Default, LoginManager.LocaCode));
